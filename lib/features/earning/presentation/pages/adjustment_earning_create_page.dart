...
class AdjustmentEarningCreatePage extends ConsumerStatefulWidget {
  final AdjustmentEarningEntity? existing;

  const AdjustmentEarningCreatePage({super.key, this.existing});

  @override
  ConsumerState<AdjustmentEarningCreatePage> createState() =>
      _AdjustmentEarningCreatePageState();
}

class _AdjustmentEarningCreatePageState
    extends ConsumerState<AdjustmentEarningCreatePage> {
  ...
  Future<void> _submit() async {
    ...
    if (_isEditing) {
      ...
      await notifier.createAdjustmentEarning(
        shiftId: _shiftId,
        occurredAt: _occurredAt,
        amount: amount,
        description: description.isEmpty ? null : description,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(_isEditing ? 'Editar ajuste' : 'Novo ajuste')),
